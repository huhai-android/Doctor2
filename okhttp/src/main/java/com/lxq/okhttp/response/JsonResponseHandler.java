...
public abstract class JsonResponseHandler implements IResponseHandler {
    ...
    public final void onSuccess(final Response response) {
        ...
        try {
            ...
            e.printStackTrace();
            OkHttpLogUtils.e("onResponse fail read response body");
        ...
        try {
            ...
            if(result instanceof JSONObject) {
                ...
                OkHttpLogUtils.e("onResponse fail parse jsonobject, body=" + finalResponseBodyStr);
                MyOkHttp.mHandler.post(new Runnable() {
                    @Override
                    public void run() {
    ...
    public void onSuccess(int statusCode, JSONObject response) {
        OkHttpLogUtils.e("onSuccess(int statusCode, JSONObject response) was not overriden, but callback was received");
    }

    public void onSuccess(int statusCode, JSONArray response) {
        OkHttpLogUtils.e("onSuccess(int statusCode, JSONArray response) was not overriden, but callback was received");
    }
