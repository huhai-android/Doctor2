...
public class MyServicecopy extends Service implements TIMMessageListener {
...
//发送消息
    ...
    public void userEventBus(UpdateEntity updateEntity) {
        ...
        installApkUtil.installApk(MyServicecopy.this, DOWNLOAD_PATH);
    ...
    private void startDownload() {
        ...
        FileDownloader.getImpl().create(mApkUrl).setWifiRequired(false).setPath(DOWNLOAD_PATH).setListener(new FileDownloadListener() {
            ...
            protected void error(BaseDownloadTask task, Throwable e) {
                ...
                if (mDialog == null) {
                    mDialog = new GroupButtonDialog(MyServicecopy.this);
                }
