...
//            empty3.setVisibility(View.GONE);
     ...
     /*   inputBorder.setVisibility(View.VISIBLE);
       ...
       /* List<AllRecordForDoctorEntity>  list =  SQLiteUtils.getInstance().selectImDataByServiceCodeAndId(mServiceCode,mIdentifier);
        ...
        mAdapter = new ChatAdapter(mTimMessages, this, mPrescriptionMessage, mImagePath, mName, mConversation, mIsHasOpenPres, mIsHasOpenTCMPres);
            ...
            case R.id.prescription:
                ...
                if (mLoginStatus != 1) {
                    ...
                    if (mIsHasOpenPres) {
                        ...
                        boolean isExists = BJCASDK.getInstance().existsCert(ChatActivity.this);

                        boolean ExistStamp = BJCASDK.getInstance().existsStamp(ChatActivity.this);
                        ...
                        if (!isExists) {
                            mDialog = new DownloadCertDialog(ChatActivity.this);
                                ...
                                public void confirm() {
                                    ...
                                    BJCASDK.getInstance().certDown(ChatActivity.this, Contants.clientId, SpUtils.getString(Contants.userName), new YWXListener() {
                                        ...
                                        public void callback(String s) {
                                            ...
                                            BJCASDK.getInstance().getUserInfo(ChatActivity.this, Contants.clientId, new YWXListener() {
                                                @Override
                                                public void callback(String s) {
                                                    Log.d("chat", "证书" + s);
                                                }
                                            ...
                                            boolean ExistStamp2 = BJCASDK.getInstance().existsStamp(ChatActivity.this);
...
//                }
            ...
            public void onSuccess(int statusCode, Entity entituy) {
                ...
                if (entituy.getCode() == 0) {
                    ...
                    if (result) {
                        ...
                        stopService(new Intent(ChatActivity.this, MyService.class));
                        LogOutUtil.getInstance().loginOut(ChatActivity.this, true);
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (position == 0) {
                ChatFragment1 chatFragment1 = (ChatFragment1) fragmentFactory.createFragment(position);
                chatFragment1.setonclickListener(new ViewClickListener() {
                    @Override
                ...
                ChatFragment2 chatFragment2 = (ChatFragment2) fragmentFactory.createFragment(position);
                chatFragment2.setonclickListener(new ViewClickListener() {
                    @Override
                    public void onclick(View view) {
                        onFragmentViewClick(view);
                    }
        ...
        switch (view.getId()) {
            ...
            case R.id.mdt_fenzhen:
                ...
                if (mIsHasOpenMDT) {
                    ...
                    Intent mdtIntent = new Intent(ChatActivity.this, PrescriptionActivity.class);
                    //先取出来
