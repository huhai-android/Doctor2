...
public class MDTInputReportFromReportActivity extends BasicActivity {
    ...
    protected void initView() {
        initTitle("诊疗建议报告").setRightText("预览").setLeftImage(R.drawable.head_back_n).setLeftOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void animateVoice(final float maxPeak) {
        ImageView recordButton = new ImageView(MDTInputReportFromReportActivity.this);
    ...
    private void showPopUpWindow() {
        View view = View.inflate(MDTInputReportFromReportActivity.this, R.layout.popup_audio_recode, null);
