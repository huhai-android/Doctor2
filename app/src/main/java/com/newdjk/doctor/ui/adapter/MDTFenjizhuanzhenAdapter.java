...
public class MDTFenjizhuanzhenAdapter extends BaseQuickAdapter<ZhanZhenListEntity.ReturnDataBean, BaseViewHolder> {

    private final Fragment fragment;
    private Gson mGson;

    public MDTFenjizhuanzhenAdapter(@Nullable List<ZhanZhenListEntity.ReturnDataBean> data, Fragment context) {
