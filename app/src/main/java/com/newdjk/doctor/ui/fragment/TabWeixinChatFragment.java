...
import com.newdjk.doctor.ui.adapter.TabChatWeixinAdapter;
 ...
 *  @描述：
 */
public class TabWeixinChatFragment extends BasicFragment {
    ...
    private TabChatWeixinAdapter mFunctionAdapter;

    @Override
    protected int initViewResId() {
        return R.layout.fragment_weixin_app;
    }
    ...
    protected void initView() {
        ...
        mFunctionAdapter = new TabChatWeixinAdapter(listall);
    ...
    public static TabWeixinChatFragment getFragment() {

        return new TabWeixinChatFragment();
    }
