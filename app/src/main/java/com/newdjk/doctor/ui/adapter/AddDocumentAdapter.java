...
public class AddDocumentAdapter extends BaseQuickAdapter<MedicalItemsEntity.MedicalsBean, BaseViewHolder> {
    private String TAG = "AddDocumentAdapter";
    private Gson mGson;
    private List<MedicalItemsEntity.MedicalsBean> datalist;
    private onDocumentAddListener listener;


    public AddDocumentAdapter(@Nullable List<MedicalItemsEntity.MedicalsBean> data) {
    ...
    @Override
    protected void convert(final BaseViewHolder helper, final MedicalItemsEntity.MedicalsBean item) {
