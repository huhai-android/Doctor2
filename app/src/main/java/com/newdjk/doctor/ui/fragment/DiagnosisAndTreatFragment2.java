...
public class DiagnosisAndTreatFragment2 extends BasicFragment {
...
//    LinearLayout noDataTip;
    ...
    public static DiagnosisAndTreatFragment2 newInstance(List<UnreadMessageEntity> allUnreadMessageList) {
        Bundle args = new Bundle();
        args.putSerializable("allUnreadMessageList", (Serializable) allUnreadMessageList);
        DiagnosisAndTreatFragment2 myFragment = new DiagnosisAndTreatFragment2();
    ...
    protected void initView() {
        mDiagnosisAndTreatAdapter = new DiagnosisAndTreatAdapter(dataList1,2);
