...
public class ConsultListFragment1 extends BasicFragment {
    ...
    private int index = 1;
    private List<ConsultMessageEntity> dataList = new ArrayList<>();
    private List<AllRecordForDoctorEntity> dataList1 = new ArrayList<>();
    public static ConsultListFragment1 newInstance(List<UnreadMessageEntity> allUnreadMessageList) {
        Bundle args = new Bundle();
        args.putSerializable("allUnreadMessageList", (Serializable) allUnreadMessageList);
        ConsultListFragment1 myFragment = new ConsultListFragment1();
    ...
    protected void initView() {
        mConsultMessageAdapter = new ConsultMessageAdapter1(dataList1,2);
...
//        }
    ...
    private void getConsultRecordList1( ) {
        List<AllRecordForDoctorEntity> list = SQLiteUtils.getInstance().selectImDataByServiceCodeAndStatus("1101",1);
