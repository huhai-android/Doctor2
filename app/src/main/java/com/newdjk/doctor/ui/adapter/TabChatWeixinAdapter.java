...
public class TabChatWeixinAdapter extends BaseQuickAdapter<AppLicationEntity, BaseViewHolder> {
    ...
    public TabChatWeixinAdapter(@Nullable List<AppLicationEntity> data, int type) {
        super(R.layout.tab_chat_weixin_item, data);

        datalist = data;
        mGson = new Gson();
        this.type=type;
    }
    public TabChatWeixinAdapter(@Nullable List<AppLicationEntity> data) {
        super(R.layout.tab_chat_weixin_item, data);
