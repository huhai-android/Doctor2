 ...
 *  @描述：
 */
public class MDTInputReportFromListActivity extends BasicActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case Download_SUCCESS:
                    // toast("文件已经下载到SDK" + downloadpath);
                    Toast.makeText(MDTInputReportFromListActivity.this, "文件已经下载到SD卡/mdt/" + downloadpath, Toast.LENGTH_LONG).show();

                    break;
                case Download_FAILED:
                    Toast.makeText(MDTInputReportFromListActivity.this, "下载失败", Toast.LENGTH_SHORT).show();
    ...
    protected void initView() {
        ...
        if (type == 2) {
            ...
            if (mMDTDetailEntity.getSubjectType() == 2) {
                initTitle("专家会诊报告").setLeftImage(R.drawable.head_back_n).setLeftOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        finish();
                    }
                ...
                initTitle("多学科会诊报告").setLeftImage(R.drawable.head_back_n).setLeftOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        finish();
                    }
        ...
        if (mMDTDetailEntity.getSubjectType() == 3) {
            for (int i = 0; i < reportlist.size(); i++) {
                if (reportlist.get(i).getIsSubmit() == 0) {
                    ...
                    btnSendReport.setBackgroundResource(R.drawable.btn_default_unclickable);
                }
            }
        }
        ...
        tvDiseaseDesc.setText((TextUtils.isEmpty(mMDTDetailEntity.getDescription()) ? "" : mMDTDetailEntity.getDescription()) + "");
    ...
    private void initRecyleview() {
        ...
        mAdviceListAdapter = new ExpertAdviceListAdapter(list, ismain, this);
    ...
    protected void initListener() {
        ...
        tvRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mMDTDetailEntity.getSubjectType()==2){
                    PDFviewUtils.getInstanse().showPDF(MDTInputReportFromListActivity.this, mMDTDetailEntity.getSubjectReportPath(), "专家会诊报告");

                }else {
                    PDFviewUtils.getInstanse().showPDF(MDTInputReportFromListActivity.this, mMDTDetailEntity.getSubjectReportPath(), "多学科会诊报告");
    ...
    public void downFile(final String path, final File file) {
        LoadDialog.show(MDTInputReportFromListActivity.this);
    ...
    private void animateVoice(final float maxPeak) {
        ImageView recordButton = new ImageView(MDTInputReportFromListActivity.this);
    ...
    private void showPopUpWindow() {
        View view = View.inflate(MDTInputReportFromListActivity.this, R.layout.popup_audio_recode, null);
