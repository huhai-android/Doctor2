 ...
 *  @描述：
 */
public class MDTInputReportFromListForNet2Activity extends BasicActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case Download_FAILED:
                    Toast.makeText(MDTInputReportFromListForNet2Activity.this, "下载失败", Toast.LENGTH_SHORT).show();
    ...
    protected int initViewResId() {
        return R.layout.activity_input_mdtreport_for_net;
    }
    ...
    protected void initView() {
        ...
        toReportDetail(mSubjectBuyRecordId+ "");
    ...
    protected void initListener() {
        ...
        tvRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mMDTDetailEntity.getSubjectType()==2){
                    PDFviewUtils.getInstanse().showPDF(MDTInputReportFromListForNet2Activity.this, mMDTDetailEntity.getSubjectReportPath(), "专家会诊报告");

                }else {
                    PDFviewUtils.getInstanse().showPDF(MDTInputReportFromListForNet2Activity.this, mMDTDetailEntity.getSubjectReportPath(), "多学科会诊报告");
    ...
    public void downFile(final String path, final File file) {
        LoadDialog.show(MDTInputReportFromListForNet2Activity.this);
    ...
    private void animateVoice(final float maxPeak) {
        ImageView recordButton = new ImageView(MDTInputReportFromListForNet2Activity.this);
    ...
    private void showPopUpWindow() {
        View view = View.inflate(MDTInputReportFromListForNet2Activity.this, R.layout.popup_audio_recode, null);
