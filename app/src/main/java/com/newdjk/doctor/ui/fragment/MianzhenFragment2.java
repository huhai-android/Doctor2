 ...
 *  @描述：
 */
public class MianzhenFragment2 extends BaseMianzhenFragment {

    private static final String TAG = "MianzhenFragment2";
    private int total = 0;
    ...
    protected void initData() {
        ...
        GetDrFaceConsultationRecord(index, 1);
    }
