...
public class ZhuanZhenListItemDialog {
    private Context mContext;
    private Dialog mDialog;

    public ZhuanZhenListItemDialog(Context mContext) {
        this.mContext = mContext;
    }

    public void show(String title, ZhanZhenListEntity.ReturnDataBean content, final DialogListener listener) {
        try {
            if (mDialog != null) {
                mDialog.dismiss();
            }
            mDialog = new Dialog(mContext, R.style.ActionSheetDialogStyle);//dialog样式
            View view = View.inflate(mContext, R.layout.dialog_group_zhuanzhenitem, null);
