...
public class SwitchAreaDialog {
    private Context mContext;
    private Dialog mDialog;

    public SwitchAreaDialog(Context mContext) {
    ...
    public void show(String title, String content, final DialogListener listener) {
        try {
            ...
            View view = View.inflate(mContext, R.layout.dialog_switch_area, null);
            ...
            if (!TextUtils.isEmpty(content)) {
                tvContent.setText("定位到当前城市为"+content+"，是否进行切换?");
            }
